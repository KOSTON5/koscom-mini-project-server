...
@Component
public class OpenAiClient implements OpenAiClientPort<AnalyzeTextRequest, AnalyzeTextResponse> {
	...
	headers.set("Authorization", "Bearer " + API_KEY);
            ...
            .bodyValue(OpenAiRequest.from(text))
            .retrieve()
            .bodyToMono(String.class)
            .block();

        log.info("OpenAiClient response : {}", response);
